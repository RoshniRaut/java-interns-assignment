...
import com.example.DeviceAPI.Filter.JwtAuthFilter;
import com.example.DeviceAPI.Service.DeveloperUserDetailsService;
...
//        return new InMemoryUserDetailsManager(user1, user);
    ...
    CorsConfigurationSource corsConfigurationSource(){
        ...
        configuration.setAllowedOrigins(List.of("http://localhost:5500","http://frontendservice:80","http://127.0.0.1:5500"));
